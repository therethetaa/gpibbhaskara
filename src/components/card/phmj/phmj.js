...
const CardContent = ({
  ...
  return (
    <div className="flex flex-col m-8 sm:m-16 items-center justify-center xl:flex-row lg:flex-row">
      {align == "right" ? (
        <div
          className="w-screen h-96 hidden xl:block xl:mr-12 lg:block lg:mr-12 rounded-xl bg-cover bg-center shadow-lg dark:shadow-black shadow-gray-500"
      ...
      <div className="w-full">
        ...
        <div
          className={`mt-5 text-lg lg:text-base text-${align} dark:text-gray-400 text-gray-700`}
          data-aos="fade-up"
        >
          <strong>{content1} </strong>
        </div>
        <div
          className={`mt-2 text-lg lg:text-base text-${align} dark:text-gray-400 text-gray-700`}
          data-aos="fade-up"
        >
          {content2}
        </div>
