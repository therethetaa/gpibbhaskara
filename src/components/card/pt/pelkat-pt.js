...
const CardContent = ({
  ...
  return (
    <div className="flex flex-col m-8 sm:m-16 items-center justify-center xl:flex-row lg:flex-row">
      {align == "right" ? (
        <div
          className="w-1/3 h-64 hidden xl:block xl:mr-12 lg:block lg:mr-12 rounded-xl bg-cover bg-center"
      ...
      {align == "left" ? (
        <div
          className="w-2/4 h-72 hidden xl:block xl:ml-12 lg:block lg:ml-12 rounded-xl bg-cover bg-center"
          style={{ backgroundImage: `url(${imgPath})` }}
          data-aos="fade-right"
        />
      ) : null}
