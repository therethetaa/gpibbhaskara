    ...
    <>
      ...
      <main className="min-h-screen">
        <div className="w-12/12 flex justify-center items-center overflow-hidden h-[75vh] md:h-auto bg-slate-300 ">
          <picture className="special-image ml-3 lg:ml-20  md:px-4 md:py-0 lg:p-0 w-full max-w-[200px] md:max-w-[200px] lg:max-w-[452px] active-hover h-auto transition-all duration-500">
            <img
              src="./img3.jpg "
              loading=" eager"
              height={600}
